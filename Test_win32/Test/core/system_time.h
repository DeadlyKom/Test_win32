...
public:
	...
	static void BusyLoopSleep(float sleep_time);

	static inline double TicksToSeconds(int64_t tick_count)
	{ return tick_count * sm_CpuTickDelta; }

	static inline double TicksToMillisecs(int64_t tick_count)
	{ return tick_count * sm_CpuTickDelta * 1000.0; }
